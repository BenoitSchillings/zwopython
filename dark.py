...
if __name__ == "__main__":
	...
	parser.add_argument("-f", "--filename", type=str, default = 'dark', help="generic file name")
	parser.add_argument("-exp", "--exp", type=float, default = 2, help="exposure in seconds (default 1.0)")
